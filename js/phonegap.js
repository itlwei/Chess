...
function Coordinates(lat, lng, alt, acc, head, vel, altacc) {
	var latitude = localStorage.getItem("longitude"),
...
//复写加速度传感器 getCurrentAcceleration 方法
(function(os){
    _extend(os.prototype,{
        getCurrentAcceleration:function(successCallback, errorCallback, options) {
            ...
            var acces = {};
            acces.x = localStorage.getItem("x");
            acces.y = localStorage.getItem("y");
            acces.z = localStorage.getItem("z");
            acces.timestamp  = new Date().getTime();
            // Get acceleration
            PhoneGap.exec(successCallback.call(navigator,acces), errorCallback, "Accelerometer", "getAcceleration", []);
        }
    })
})(Accelerometer);

//复写方向（罗盘）传感器 getCurrentHeading 方法
(function(os){
    _extend(os.prototype,{
        getCurrentHeading:function(successCallback, errorCallback, options) {
            ...
            var acces = {};
            acces.magneticHeading = localStorage.getItem("orih");

            // Get heading
            PhoneGap.exec(successCallback.call(navigator,acces), errorCallback, "Compass", "getHeading", []);
        }
    });
})(Compass);

//复写GPS传感器 getCurrentPosition 方法
(function(os){
    _extend(os.prototype,{
...
PhoneGap.addConstructor(function() {
    if (typeof navigator._geo == "undefined") navigator._geo = new Geolocation();
